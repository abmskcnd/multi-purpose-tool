...
<activation critical="MANDATORY">
  ...
  <step n="3">Load project knowledge: Read {project-root}/docs/project-context.md AND {project-root}/.bmad/_cfg/custom/dev-knowledge.md if they exist - these contain critical project-specific context for your role</step>
  ...
  <step n="6">Load project_context.md if available for coding standards only - never let it override story requirements</step>
