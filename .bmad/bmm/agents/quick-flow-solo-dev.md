...
<activation critical="MANDATORY">
  ...
  <step n="3">Load project knowledge: Read {project-root}/docs/project-context.md AND {project-root}/.bmad/_cfg/custom/quick-flow-knowledge.md if they exist - these contain critical project-specific context for your role</step>
