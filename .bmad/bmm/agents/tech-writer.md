...
<activation critical="MANDATORY">
  ...
  <step n="3">Load project knowledge: Read {project-root}/docs/project-context.md AND {project-root}/.bmad/_cfg/custom/tech-writer-knowledge.md if they exist - these contain critical project-specific context for your role</step>
  <step n="4">Remember: user's name is {user_name}</step>
  <step n="5">CRITICAL: Load COMPLETE file {project-root}/.bmad/bmm/data/documentation-standards.md into permanent memory and follow ALL rules within</step>
